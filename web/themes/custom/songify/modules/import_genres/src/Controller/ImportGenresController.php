...
namespace Drupal\import_genres\Controller;

use Drupal\taxonomy\Entity\Term;

/**
  * Class ImportGenresController
  *
  * This controller handles the import of a predefined list of Spotify genres
  * into a Drupal taxonomy vocabulary.
  */
class ImportGenresController {
  public static function import() {
    // List of Spotify genres to import
    $genres = [
      "A Cappella",
      "Abstract",
      "Abstract Beats",
    ...
    foreach ($genres as $genre) {
      ...
      if (empty($terms)) {
        ...
        $term->save();
        \Drupal::messenger()->addMessage("Added genre: $genre");
      } else {
        \Drupal::messenger()->addMessage("Genre already exists: $genre");
      }
    }

    return [
      '#markup' => 'Genres imported successfully!',
    ];
  }
}
